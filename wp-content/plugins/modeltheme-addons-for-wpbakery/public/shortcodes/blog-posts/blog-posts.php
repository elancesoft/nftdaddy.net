      ...
      <?php echo wp_kses_post($swiper_container_start); ?>
        <div class="mt-swipper-carusel-position" style="position:relative;">
          ...
          <div id="<?php echo esc_attr($id); ?>" 
            ...
            class="mt-addons-blog-posts-carousel <?php echo esc_attr($style_var_value); ?> row <?php echo esc_attr($carousel_holder_class); ?>">
                    ...
                    <div class="mt-addons-blog-posts-carousel-single-post <?php echo esc_attr($carousel_item_class); ?>">
                      <div class="mt-addons-blog-posts-carousel-single-post-wrapper" style="<?php echo $overlay_bg_style; ?>">
                        ...
                        <div class="mt-addons-blog-posts-carousel-head-content">
                          ...
                          <h3 class="mt-addons-blog-posts-carousel-post-name"><a href="<?php echo get_permalink(get_the_ID());?>" style="color:<?php echo esc_attr($text_color);?>;font-weight:<?php echo $title_weight; ?>;font-size:<?php echo $title_size; ?>px;line-height: <?php echo $title_line; ?>"><?php echo esc_attr(get_the_title());?></a></h3>
