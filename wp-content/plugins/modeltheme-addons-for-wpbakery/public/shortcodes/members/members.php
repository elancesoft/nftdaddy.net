            ...
            <?php if ($member_groups) { ?>
              <?php foreach ($member_groups as $param) {
               ...
               $image_size = 'full';
                ...
                $image_members = wp_get_attachment_image_src( $param['list_image'], $image_size ); ?>
                      ...
                      <div class="mt-addons-member-image-flex-zone <?php echo $image_shape; ?>" style="<?php echo $overlay_bg_style; ?>">
                        <div class="mt-addons-member-image-flex-zone-inside member_social social-icons">
                          ...
                          <?php if (isset($param['pinterest']) && !empty($param['pinterest'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['pinterest']); ?>"><i class="fa fa-pinterest"></i></a>
                          <?php } ?>
                          <?php if (isset($param['instagram']) && !empty($param['instagram'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['instagram']); ?>"><i class="fa fa-instagram"></i></a>
                          <?php } ?>
                          <?php if (isset($param['youtube']) && !empty($param['youtube'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['youtube']); ?>"><i class="fa fa-youtube"></i></a>
                          <?php } ?>
                          <?php if (isset($param['dribbble']) && !empty($param['dribbble'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['dribbble']); ?>"><i class="fa fa-dribbble"></i></a>
                          <?php } ?>
                          <?php if (isset($param['linkedin']) && !empty($param['linkedin'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['linkedin']); ?>"><i class="fa fa-linkedin"></i></a>
                          <?php } ?>
                          <?php if (isset($param['deviantart']) && !empty($param['deviantart'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['deviantart']); ?>"><i class="fa fa-deviantart"></i></a>
                          <?php } ?>
                          <?php if (isset($param['digg']) && !empty($param['digg'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['digg']); ?>"><i class="fa fa-digg"></i></a>
                          <?php } ?>
                          <?php if (isset($param['flickr']) && !empty($param['flickr'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['flickr']); ?>"><i class="fa fa-flickr"></i></a>
                          <?php } ?>
                          <?php if (isset($param['tumblr']) && !empty($param['tumblr'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['tumblr']); ?>"><i class="fa fa-tumblr"></i></a>
                          <?php } ?>
                          <?php if (isset($param['stumbleupon']) && !empty($param['stumbleupon'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['stumbleupon']); ?>"><i class="fa fa-stumbleupon"></i></a>
                          <?php } ?>
                          <?php if (isset($param['email']) && !empty($param['email'])) { ?>
                            <a <?php echo $links_target_attr; ?> style="<?php echo $icons_color_style; ?>" href="<?php echo esc_url($param['email']); ?>"><i class="fa fa-envelope"></i></a>
                          <?php } ?>
                        </div>
                      </div>
                    </div>
