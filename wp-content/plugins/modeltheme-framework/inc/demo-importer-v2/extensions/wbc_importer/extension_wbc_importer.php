    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        if ( class_exists( 'RevSlider' ) ) {
            ...
            $wbc_sliders_array = array(
                'Main Home' => array(''),
                'Metaverse' => array('metaverse-slider.zip'),
                'Crypto Consulting' => array('homenftconsultant.zip'),
                'Trading Consulting' => array('trading_slider.zip'),
                'Crypto Investments' => array(''),
                'Crypto Wallet' => array('crypto-wallet.zip'),
                'Crypto Blockchain' => array(''),
                'Forex Consulting' => array(''),
                'NFT Musician' => array(''),
                'Crypto Blogging' => array(''),
                'Smart Contract' => array(''),
                'NFT Marketplace Dark' => array(''),
            );
        ...
        *************************************************************************/
        ...
        $wbc_menu_array = array( 
            ...
            'Crypto Blogging',
            'Smart Contract',
            'NFT Marketplace Dark',

        );
        if ( isset( $demo_active_import[$current_key]['directory'] ) && !empty( $demo_active_import[$current_key]['directory'] ) && in_array( $demo_active_import[$current_key]['directory'], $wbc_menu_array ) ) {
            $top_menu = get_term_by( 'name', 'Header 2', 'nav_menu' );
        ...
        */
        ...
        $wbc_home_pages = array(
            'Main Home'                 => 'Main Home',
            'Metaverse'                 => 'Metaverse' ,
            'Crypto Consulting'         => 'Crypto Consultant',    
            'Trading Consulting'        => 'Trading Consulting Agency',
            'Crypto Investments'        => 'Crypto Investments',
            'Crypto Wallet'             => 'Crypto Wallet',
            'Crypto Blockchain'         => 'Crypto Blockchain',
            'Forex Consulting'          => 'Forex Consulting',
            'NFT Musician'              => 'NFT Musician',
            'Crypto Blogging'           => 'Crypto Blogging',
            'Smart Contract'            => 'Smart Contract',
            'NFT Marketplace Dark'      => 'NFT Marketplace Dark',
