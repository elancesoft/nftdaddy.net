      ...
      <?php echo wp_kses_post($container_row_start); ?> 
        <div class="mt-addons-pricing-table-section-v2 " id="<?php echo esc_attr($colors_ID); ?>" style="background:<?php echo esc_attr($package_background_color); ?>;">
         ...
         <?php }?>
          ...
          <p class="mt-addons-pricing-table-sub-v2 text-right" style="color:<?php echo esc_attr($package_description_color); ?>;font-size:<?php echo esc_attr($description_size); ?>px;"><?php echo esc_html($package_description); ?>
          </p>
          <ul class="mt-addons-pricing-table-feature-v2 <?php echo esc_attr($no_container_row); ?>">
          <?php $pricing_groups_content = vc_param_group_parse_atts($params['pricing_groups']);?>
