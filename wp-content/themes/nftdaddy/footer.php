<!--  ====================== Footer Area Start =============================  -->
<footer class="footer-area bg-bottom bg-cover md:pt-20 pt-10 md:pb-28 pb-14 relative" style="background-image: url(assets/images/bg-footer.svg);">
		...
		<div class="grid sm:grid-cols-2 gap-10 xl:grid-cols-12 z-40 relative">
			<div class="xl:col-span-5 ">
				<div data-aos="fade-in" data-aos-duration="500" class="footer-widgets">
					<h4 class="mb-6 text-2xl font-bold text-coolGray-900">About Us</h4>
					<p class="mb-6 text-base font-normal text-coolGray-600">Poetic taken a torn return emerged. Or
						thought. Variety a its parents time the oparents this as the of been logbook.
					</p>
					<div class="share-links">
						<ul>
							<li data-aos="fade-in" data-aos-duration="500" class="inline-block mr-2">
								<a class="flex button-style-1     relative    overflow-hidden items-center justify-center  rounded-full h-9 w-9 bg-blue-50" href="#">
							...
							<li data-aos="fade-in" data-aos-duration="500" class="inline-block mr-2">
								<a class="flex button-style-1     relative     overflow-hidden items-center justify-center  rounded-full h-9 w-9 bg-lightBlue-400" href="#">
							...
							<li class="inline-block mr-2">
								<a class="flex button-style-1     relative     overflow-hidden items-center justify-center  bg-red-500 rounded-full h-9 w-9" href="#">
							...
							<li class="inline-block mr-2">
								<a class="flex button-style-1     relative    overflow-hidden items-center justify-center  bg-blue-600 rounded-full h-9 w-9" href="#">
									<svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class=" xl:col-span-3 ">
				<div data-aos="fade-in" data-aos-duration="500" class="footer-widgets">
					<h4 class="mb-6 text-2xl font-bold text-coolGray-900">Contact</h4>
					<p class="mb-4 text-base font-normal text-coolGray-600">12 New Elephant Road, P.O. 1334 NY,
						United
						States
					</p>
					<p class="mb-4 text-base font-normal text-coolGray-600">P. 012 345 678 90</p>
					<p class="text-base font-normal text-coolGray-600">E. support@themeix.com</p>
				</div>
			</div>
			<div class="xl:col-span-2 ">
				<div data-aos="fade-in" data-aos-duration="500" class="footer-widgets">
					<h4 class="mb-6 text-2xl font-bold text-coolGray-900">Web Links</h4>
					<ul>
						<li data-aos="fade-in" data-aos-duration="500" class="mb-4 "><a class="text-base font-normal text-coolGray-600 underline-hover" href="collection.html">Collections</a></li>
						<li data-aos="fade-in" data-aos-duration="500" class="mb-4 "><a class="text-base font-normal text-coolGray-600 underline-hover" href="single-item-v3.html">Item Details</a></li>
						<li data-aos="fade-in" data-aos-duration="500" class="mb-4 "><a class="text-base font-normal text-coolGray-600 underline-hover" href="rankings.html">Rankings</a></li>
						<li data-aos="fade-in" data-aos-duration="500" class=""><a class="text-base font-normal text-coolGray-600 underline-hover" href="sign-in.html">User
								Profile</a>
						</li>
					</ul>
				</div>
			...
			<div class="xl:col-span-2 ">
				<div data-aos="fade-in" data-aos-duration="500" class="footer-widgets">
					<h4 class="mb-6 text-2xl font-bold text-coolGray-900">My Account</h4>
					<ul>
						<li data-aos="fade-in" data-aos-duration="500" class="mb-4 "><a class="text-base font-normal text-coolGray-600 underline-hover" href="creator-edit.html">Creator Dashboard</a></li>
						<li data-aos="fade-in" data-aos-duration="500" class="mb-4 "><a class="text-base font-normal text-coolGray-600 underline-hover" href="wallet.html">Wallet</a>
						</li>
						<li data-aos="fade-in" data-aos-duration="500" class="mb-4 "><a class="text-base font-normal text-coolGray-600 underline-hover" href="categories.html">Create Item</a></li>
						<li data-aos="fade-in" data-aos-duration="500" class=""><a class="text-base font-normal text-coolGray-600 underline-hover" href="my-account.html">My
								Account</a>
						</li>
					</ul>
				</div>
		...
		<div class="sm:text-center copyright-area md:text-right pt-7 md:pt-14 z-40 relative">
			<div class="justify-between md:flex">
				<div class="grid flex-col order-first md:order-last">
					<ul>
						<li data-aos="fade-in" data-aos-duration="500" class="inline-block mr-2"><a class="text-base text-coolGray-600 underline-hover" href="privacy-policy.html">Privacy
								Policy</a>
						</li>
						<li data-aos="fade-in" data-aos-duration="500" class="inline-block mr-2 text-base text-coolGray-600">|</li>
						<li data-aos="fade-in" data-aos-duration="500" class="inline-block"><a class="text-base text-coolGray-600 underline-hover" href="terms.html">Term of
								Service</a>
						</li>
					</ul>
				</div>
				<div class="flex-col">
					<p class="text-base font-normal text-coolGray-600">© Copyright - <span id="spanYear"></span>
						Tokenbay
						- Designed by <a class="text-indigo-500 underline-hover" href="http://themeix.com/">Themeix</a>
					</p>
				</div>
			</div>
		</div>
