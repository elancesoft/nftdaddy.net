...
function modeltheme_addons_for_wpbakery_collectors_list($params, $content) {
    ...
    wp_enqueue_style( 'products-category-banner-css', plugins_url( '../../css/collectors-list.css' , __FILE__ ));
       ...
       <div class="mt-single-category <?php echo $number_of_columns;?>">
        <div class="mt-single-category-wrap">
            ...
            <div class="mt-single-category-info">
              <a href="<?php echo get_term_link($category->slug, 'product_cat'); ?>"><?php echo esc_attr($category->name);?></a>
              <span><?php echo esc_attr($category->count);?> <?php echo esc_html__('items','modeltheme-addons-for-wpbakery'); ?></span>
            </div>
