...
if (!class_exists('Modeltheme_Addons_For_Wpbakery_Number_Param')) {
    class Modeltheme_Addons_For_Wpbakery_Number_Param {
        ...
        function number_field($settings, $value) {
            ...
            $output = '<div class="mt-addons-number-wrap">';
...
if (class_exists('Modeltheme_Addons_For_Wpbakery_Number_Param')) {
    new Modeltheme_Addons_For_Wpbakery_Number_Param();
}
