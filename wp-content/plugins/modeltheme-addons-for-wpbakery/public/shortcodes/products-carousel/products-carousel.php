            ...
            <?php foreach ($products as $prod) {
              ...
              <div id="product-id-<?php echo esc_attr($prod->ID);?>" class="<?php echo esc_attr($carousel_item_class); ?>">
                  <div class="mt-addons-products-carousel-slider-wrapper">
                    ...
                    <div class="mt-addons-products-carousel-title-metas text-center">
                      ...
                      <?php if($product->get_price_html()) { ?>
                        <p>
                          <?php echo esc_attr__('Price','modeltheme-addons-for-wpbakery');?> <?php echo $product->get_price_html();?>
                        </p>
                      <?php } ?>
                         

                       <?php 
                      //modeltheme-addons-for-wpbakery.php - modeltheme_mt_addons_products_carousel
                       //do_action('modeltheme_addons_for_wpbakery_mt_addons_products_carousel', $prod->ID, 'button_on');?>
                    </div>
                  </div>
              </div>
            <?php } ?>
