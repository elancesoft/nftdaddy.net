  ...
  function modeltheme_addons_icons_vc_fields($group_name = ''){
    $icons_vc_fields = array(
      ...
      array(
        ...
        "holder" => "div",
        "class" => "",
        "heading" => esc_attr__( "Choose an image", 'modeltheme' ),
        "param_name" => "image",
        "value" => "",
        'dependency' => array(
            'element' => 'icon_type',
        ...
        "description" => esc_attr__( "Upload a PNG or JPG icon or image.", 'modeltheme' )
      ),
      array(
        "group" => $group_name,
        "type" => "vc_number",
        ...
        "description" => esc_attr__( "Default: 50 (px). Leave empty for auto width.", "modeltheme" )
      ),
      array(
        "group" => $group_name,
        "type" => "vc_number",
        "holder" => "div",
        "class" => "",
        "heading" => esc_attr__("Image Margin right", 'modeltheme'),
        ...
        "description" => esc_attr__( "Leave empty for auto width.", "modeltheme" )
      ),
      array(
        "group" => $group_name,
...
if (!function_exists('modeltheme_addons_carousel_attributes')) {
  function modeltheme_addons_carousel_attributes($carousel_id = '', $items_desktop = '', $items_tablet = '', $items_mobile = '', $navigation = '', $pagination = '', $autoplay = '', $slide_speed = '', $pagination_speed = ''){
    ?>
        data-carousel-id="<?php echo esc_attr($carousel_id); ?>" 
        data-carousel-desktop-items="<?php echo esc_attr($items_desktop); ?>" 
        data-carousel-tablet-items="<?php echo esc_attr($items_tablet); ?>" 
        data-carousel-mobile-items="<?php echo esc_attr($items_mobile); ?>" 
        data-carousel-navigation="<?php echo esc_attr($navigation); ?>" 
        data-carousel-pagination="<?php echo esc_attr($pagination); ?>" 
        data-carousel-autoplay="<?php echo esc_attr($autoplay); ?>" 
        data-carousel-slide-speed="<?php echo esc_attr($slide_speed); ?>" 
        data-carousel-pagination-speed="<?php echo esc_attr($pagination_speed); ?>" 
    <?php 
  }
}
