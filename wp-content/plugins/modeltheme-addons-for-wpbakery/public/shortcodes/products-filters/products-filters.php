                    ...
                    <div class="mt-addons-product-wrapper">
                      ...
                      <div class="mt-addons-title-metas">
                        <h3 class="mt-addons-product-title">
                          <a href="<?php echo esc_url(get_permalink($blogpost->ID));?>" title="<?php echo $blogpost->post_title;?>"><?php echo $blogpost->post_title;?></a>
                        </h3>
                      ...
                      if (in_array($tax->attribute_name, $attributes_to_list)) { ?>
                        ...
                        foreach ($attributes_array as $key ) {
                          foreach ($taxonomies_terms[$key] as $term) { ?>
                            <li>
                              <input class="filter" data-filter=".<?php echo $term->slug;?>" type="checkbox" id="<?php $term->slug; ?>">
                              <label class="checkbox-label" for="<?php $term->slug; ?>"><?php $term->name;?></label>
                            </li>
                          <?php }
                        }
                      } ?>
                  ...
                  <div class="mt-addons-filter-block">
                    ...
                    <ul class="mt-addons-filter-content mt-addons-filters list">               
                      <?php foreach($product_categories as $category){ ?>
                        <li>
                          <input class="filter" data-filter=".<?php echo $category->slug;?>" type="checkbox" id="<?php echo $category->slug;?>">
                          <label class="checkbox-label" for="<?php echo $category->slug;?>"><?php echo $category->name;?></label>
                        </li>                
                      <?php } ?>    
                    </ul>
                  </div>
                  ...
                  <div class="mt-addons-filter-block">
                    ...
                    <ul class="mt-addons-filter-content mt-addons-filters list">             
                      <?php foreach($product_tags as $tag){ ?>
                        <li>
                          <input class="filter" data-filter=".<?php echo $tag->slug;?>" type="checkbox" id="<?php echo $tag->slug;?>">
