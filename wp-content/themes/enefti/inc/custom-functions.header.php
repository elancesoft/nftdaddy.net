...
if (!function_exists('enefti_dynamic_css')) {
	...
	function enefti_dynamic_css(){
	    ...
	    $html = '';
	   	if (is_page()) {
		    $enefti_custom_page_skin_color_status = get_post_meta( get_the_ID(), 'enefti_custom_page_skin_color_status', true );
			...
			if (isset($enefti_custom_page_skin_color_status) AND $enefti_custom_page_skin_color_status == 'yes') {
				...
				$back_to_top = $enefti_global_page_color;
				$html .= '	.back-to-top{
								background-color: '.esc_html($enefti_style_main_backgrounds_color).'; 
							}';
			}else{
