...
function modeltheme_addons_for_wpbakery_title_subtitle($params, $content) {
    ...
    ob_start(); ?>
    <div id="<?php echo $el_custom_id; ?>" class="mt-addons-title-subtile <?php echo $el_class; ?>">
      ...
      <?php if (($separator_status && $subtitle_position == 'up')) { ?>
        <?php if ($separator_type == "image") { ?>
          <div class="mt-addons-title-border" style="background: url(<?php echo $separator[0]; ?>) no-repeat center center;"></div>
      ...
      <<?php echo $title_tag; ?>><p class="mt-addons-title-section <?php echo $section_align;?>" style="color:<?php echo $title_color; ?>;font-weight:<?php echo $title_weight; ?>;font-size:<?php echo $title_size; ?>px;line-height: <?php echo $title_line; ?>"><?php echo esc_html__($title); ?></p></<?php echo $title_tag;?>>
