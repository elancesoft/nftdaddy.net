        ...
        <?php foreach ($texts_groups as $text) {?>
          ...
          <?php } else if($text['text_type'] == "highlighted") { ?>
              <?php if(!empty($text['text_highlighted'])){ ?>
                <span class="mt-addons-text-highlighted" style="<?php echo esc_attr($highlight_color_bg.' '.$color_style.' '.$title_size_style.' '.$title_weight_style. ' '.$title_line_style); ?>">
...
if (function_exists('vc_map')) {
  ...
  $params = array(
    ...
    array(
      ...
      "holder" => "div",
      "class" => "",
      "heading" => esc_attr__("Highligh Color", 'modeltheme-addons-for-wpbakery'),
