...
<?php if ( class_exists( 'ReduxFrameworkPlugin' ) ) { ?>
  <?php if ( enefti_redux('enefti_contact_phone') != '' || enefti_redux('enefti_contact_email') != '' || enefti_redux('enefti_work_program') != '') { ?>
        ...
        <div class="col-md-7 col-sm-12 contact-header">
          <?php if($enefti_redux['enefti_contact_phone']) { ?>
            ...
            <div class="header-top-contact-method">
              <span><?php esc_html_e('Call us toll free: ', 'enefti'); ?></span>
              <a target="_blank" href="<?php echo esc_url('tel:'.$enefti_redux['enefti_contact_phone']); ?>">
                <i class="fa fa-phone hide-on-desktops"></i>
                <span><?php echo esc_html($enefti_redux['enefti_contact_phone']); ?></span>
              </a>
            </div>
          <?php } ?>
          ...
          <?php if($enefti_redux['enefti_contact_email']) { ?>
            <!-- Mail Us -->
            <div class="header-top-contact-method">
              <span><?php esc_html_e('Send us an email: ', 'enefti'); ?></span>
              <a target="_blank" href="<?php echo esc_url('mailto:'.$enefti_redux['enefti_contact_email']); ?>">
                <i class="fa fa-envelope-o hide-on-desktops"></i>
                <span><?php echo esc_html($enefti_redux['enefti_contact_email']); ?></span>
              </a>
            </div>
          <?php } ?>
        ...
        <div class="col-md-5 col-sm-12 account-urls">
          <?php if( function_exists( 'YITH_WCWL' ) ){ ?>
            <a class="top-payment" href="<?php echo esc_url($wishlist_url); ?>">
              ...
              <?php esc_html_e('Wishlist', 'enefti'); ?>
            </a>
          <?php } ?>
        </div>
      </div>
            ...
            <div class="col-md-3 search-form-product">
              ...
              <div class="enefti-header-searchform">
                <form name="header-search-form" method="GET" class="woocommerce-product-search menu-search" action="<?php echo esc_url(home_url('/')); ?>">
                  ...
                  <?php do_action('enefti_header6_search_form_before'); ?>
