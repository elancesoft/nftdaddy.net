 ...
 */
function enefti_testimonial_custom_post() {
...
add_action('init', 'enefti_testimonial_custom_post');
...
*/
function smartowl_clients_custom_post() {
...
add_action('init', 'smartowl_clients_custom_post');
